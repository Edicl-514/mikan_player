...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1312461637;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        15 => wire__crate__api__config__get_bangumi_api_url_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__config__get_bangumi_url_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__config__get_bgmlist_url_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__mikan__get_mikan_resources_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__config__get_mikan_url_impl(port, ptr, rust_vec_len, data_len),
        20 => {
            wire__crate__api__config__get_playback_sub_url_impl(port, ptr, rust_vec_len, data_len)
        }
        21 => wire__crate__api__network__get_system_proxy_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__simple__get_torrent_stats_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__simple__get_tracker_info_impl(port, ptr, rust_vec_len, data_len),
        ...
        26 => wire__crate__api__mikan__search_mikan_anime_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__simple__start_torrent_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__simple__stop_torrent_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__config__update_config_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__simple__update_config_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
