...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2017354467;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        20 => wire__crate__api__dmhy__fetch_dmhy_resources_impl(port, ptr, rust_vec_len, data_len),
        21 => {
        ...
        23 => wire__crate__api__crawler__fill_anime_details_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__generic_scraper__generic_search_and_play_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__generic_scraper__generic_search_and_play_with_episode_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__generic_scraper__generic_search_play_pages_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__generic_scraper__generic_search_play_pages_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__generic_scraper__generic_search_with_channels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__crate__api__generic_scraper__generic_search_with_channels_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        30 => wire__crate__api__generic_scraper__generic_search_with_progress_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__generic_scraper__generic_search_with_progress_runtime_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        33 => wire__crate__api__config__get_bangumi_api_url_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__config__get_bangumi_url_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__config__get_bgmlist_url_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__config__get_cache_dir_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__captcha__get_captcha_ocr_model_info_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__config__get_download_dir_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__generic_scraper__get_enabled_source_names_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__generic_scraper__get_episode_play_url_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        41 => wire__crate__api__config__get_max_concurrent_searches_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        42 => wire__crate__api__mikan__get_mikan_resources_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__config__get_mikan_url_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__generic_scraper__get_playback_sources_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        47 => wire__crate__api__network__get_system_proxy_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__simple__get_torrent_stats_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__simple__get_tracker_info_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__simple__greet_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__api__config__init_config_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__simple__init_engine_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__api__captcha__initialize_captcha_ocr_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        54 => wire__crate__api__captcha__is_captcha_ocr_initialized_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__config__is_source_enabled_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__simple__pause_torrent_impl(port, ptr, rust_vec_len, data_len),
        57 => wire__crate__api__simple__preload_playback_source_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__generic_scraper__preload_playback_sources_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__api__captcha__recognize_captcha_impl(port, ptr, rust_vec_len, data_len),
        60 => wire__crate__api__captcha__recognize_captcha_with_constraints_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        61 => wire__crate__api__generic_scraper__refresh_playback_source_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        62 => wire__crate__api__simple__refresh_playback_source_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        63 => wire__crate__api__simple__resume_torrent_impl(port, ptr, rust_vec_len, data_len),
        64 => wire__crate__api__ranking__search_bangumi_subject_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        65 => wire__crate__api__mikan__search_mikan_anime_impl(port, ptr, rust_vec_len, data_len),
        66 => {
        ...
        68 => wire__crate__api__config__set_max_concurrent_searches_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        69 => wire__crate__api__simple__set_max_concurrent_searches_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        70 => wire__crate__api__simple__start_torrent_impl(port, ptr, rust_vec_len, data_len),
        71 => wire__crate__api__simple__stop_torrent_impl(port, ptr, rust_vec_len, data_len),
        72 => wire__crate__api__config__update_config_impl(port, ptr, rust_vec_len, data_len),
        73 => wire__crate__api__simple__update_config_impl(port, ptr, rust_vec_len, data_len),
        74 => wire__crate__api__generic_scraper__update_single_source_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
