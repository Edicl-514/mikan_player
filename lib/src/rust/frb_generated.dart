...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<BangumiEpisodeComment>>
  crateFrbApiBangumiFetchBangumiCharacterComments({
  ...
  Future<List<BangumiEpisodeComment>>
  crateFrbApiBangumiFetchBangumiPersonComments({
  ...
  Future<BangumiTopicsPage> crateFrbApiBangumiFetchBangumiSubjectTopics({
    required PlatformInt64 subjectId,
    required int page,
  });

  Future<BangumiTopicDetail> crateFrbApiBangumiFetchBangumiTopicDetail({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  crateFrbApiBangumiFetchBangumiCharacterComments({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFrbApiBangumiFetchBangumiCharacterCommentsConstMeta,
  ...
  TaskConstMeta get kCrateFrbApiBangumiFetchBangumiCharacterCommentsConstMeta =>
      const TaskConstMeta(
        debugName: "fetch_bangumi_character_comments",
  ...
  crateFrbApiBangumiFetchBangumiPersonComments({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFrbApiBangumiFetchBangumiPersonCommentsConstMeta,
        argValues: [personId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFrbApiBangumiFetchBangumiPersonCommentsConstMeta =>
      const TaskConstMeta(
        debugName: "fetch_bangumi_person_comments",
        argNames: ["personId"],
      );
  ...
  Future<BangumiTopicsPage> crateFrbApiBangumiFetchBangumiSubjectTopics({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bangumi_topics_page,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateFrbApiBangumiFetchBangumiSubjectTopicsConstMeta,
        argValues: [subjectId, page],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFrbApiBangumiFetchBangumiSubjectTopicsConstMeta =>
      const TaskConstMeta(
        debugName: "fetch_bangumi_subject_topics",
        argNames: ["subjectId", "page"],
      );
  ...
  Future<BangumiTopicDetail> crateFrbApiBangumiFetchBangumiTopicDetail({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_i_64(topicId, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 41,
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bangumi_topic_detail,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateFrbApiBangumiFetchBangumiTopicDetailConstMeta,
        argValues: [topicId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFrbApiBangumiFetchBangumiTopicDetailConstMeta =>
      const TaskConstMeta(
        debugName: "fetch_bangumi_topic_detail",
        argNames: ["topicId"],
      );
  ...
  @protected
  BangumiTopic dco_decode_bangumi_topic(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 8)
    ...
    return BangumiTopic(
      ...
      repliesCount: dco_decode_i_32(arr[7]),
    );
  }

  @protected
  BangumiTopicDetail dco_decode_bangumi_topic_detail(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 13)
      throw Exception('unexpected arr length: expect 13 but see ${arr.length}');
    return BangumiTopicDetail(
      id: dco_decode_i_64(arr[0]),
      title: dco_decode_String(arr[1]),
      userId: dco_decode_String(arr[2]),
      userName: dco_decode_String(arr[3]),
      ...
      contentHtml: dco_decode_String(arr[9]),
      contentState: dco_decode_i_32(arr[10]),
      reactions: dco_decode_list_bangumi_comment_reaction(arr[11]),
      replies: dco_decode_list_bangumi_episode_comment(arr[12]),
    );
  }

  @protected
  BangumiTopicsPage dco_decode_bangumi_topics_page(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BangumiTopicsPage(
      topics: dco_decode_list_bangumi_topic(arr[0]),
      total: dco_decode_opt_box_autoadd_i_32(arr[1]),
      fetchedCount: dco_decode_i_32(arr[2]),
    );
  }
  ...
  @protected
  List<BangumiTopic> dco_decode_list_bangumi_topic(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bangumi_topic).toList();
  }
  ...
  @protected
  BangumiTopic sse_decode_bangumi_topic(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_i_64(deserializer);
    var var_userId = sse_decode_String(deserializer);
    var var_userName = sse_decode_String(deserializer);
  ...
  @protected
  BangumiTopicDetail sse_decode_bangumi_topic_detail(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_i_64(deserializer);
    ...
    var var_content = sse_decode_String(deserializer);
    var var_contentHtml = sse_decode_String(deserializer);
    var var_contentState = sse_decode_i_32(deserializer);
    var var_reactions = sse_decode_list_bangumi_comment_reaction(deserializer);
    var var_replies = sse_decode_list_bangumi_episode_comment(deserializer);
    return BangumiTopicDetail(
      id: var_id,
  ...
  @protected
  BangumiTopicsPage sse_decode_bangumi_topics_page(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_topics = sse_decode_list_bangumi_topic(deserializer);
    var var_total = sse_decode_opt_box_autoadd_i_32(deserializer);
    var var_fetchedCount = sse_decode_i_32(deserializer);
    return BangumiTopicsPage(
      topics: var_topics,
      total: var_total,
  ...
  @protected
  List<BangumiTopic> sse_decode_list_bangumi_topic(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BangumiTopic>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bangumi_topic(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  void sse_encode_bangumi_topic(BangumiTopic self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.id, serializer);
    sse_encode_String(self.userId, serializer);
    sse_encode_String(self.userName, serializer);
  ...
  @protected
  void sse_encode_bangumi_topic_detail(
    BangumiTopicDetail self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.id, serializer);
    ...
    sse_encode_String(self.content, serializer);
    sse_encode_String(self.contentHtml, serializer);
    sse_encode_i_32(self.contentState, serializer);
    sse_encode_list_bangumi_comment_reaction(self.reactions, serializer);
    sse_encode_list_bangumi_episode_comment(self.replies, serializer);
  }

  @protected
  void sse_encode_bangumi_topics_page(
    BangumiTopicsPage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_bangumi_topic(self.topics, serializer);
    sse_encode_opt_box_autoadd_i_32(self.total, serializer);
    sse_encode_i_32(self.fetchedCount, serializer);
  }
  ...
  @protected
  void sse_encode_list_bangumi_topic(
    List<BangumiTopic> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bangumi_topic(item, serializer);
    }
  }
