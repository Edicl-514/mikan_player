...
// These functions are ignored because they are not marked as `pub`: `absolutize_url`, `apply_browser_page_headers`, `apply_cookie_header`, `build_episode_table_cache`, `build_search_candidates`, `calculate_match_score`, `current_timestamp_ms`, `extract_channel_name`, `extract_core_name`, `extract_episode_number_from_text`, `generic_search_and_play_internal`, `get_cache_file_path`, `get_episode_cache_dir`, `get_episode_cache_path`, `hash_str`, `is_expired`, `load_episode_table_cache`, `load_from_cache`, `load_playback_source_config`, `merge_cookie_strings`, `parse_chinese_number`, `parse_episode_table_from_detail`, `preprocess_search_term`, `save_episode_table_cache`, `save_to_cache`, `search_single_source_with_channels`, `search_single_source_with_progress`, `search_single_source`, `select_episode_by_number`, `select_episode_from_table`, `source_config_hash`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `CachedEpisodeTable`, `CaptchaConfig`, `ExportedMediaSourceDataList`, `MatchVideo`, `MediaSource`, `OcrConstraints`, `SEASON_RE`, `SampleRoot`, `SearchConfig`, `SelectorChannelFormatFlattened`, `SelectorChannelFormatNoChannel`, `SelectorSubjectFormatA`, `SelectorSubjectFormatIndexed`, `SourceArguments`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `deref`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `initialize`
