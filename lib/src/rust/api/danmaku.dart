...
// These functions are ignored because they are not marked as `pub`: `build_signed_headers`, `extract_url_path`, `generate_signature`, `get_app_id`, `get_app_secret`, `get_bangumi_episodes`, `get_by_bangumi_id`, `get_by_title`, `get_comments`, `get_episodes`, `match_anime`, `parse_danmaku_comment`, `production`, `relative_episode_index`, `search_anime`, `send`, `signed_headers`, `url`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `BangumiDetail`, `BangumiResponse`, `BangumiTvDetail`, `BangumiTvEpisodeApi`, `BangumiTvResponse`, `DanmakuApiClient`, `DanmakuComment`, `DanmakuResponse`, `EpisodeApi`, `MatchResponse`, `MatchResultApi`, `SearchAnimeApi`, `SearchResponse`
