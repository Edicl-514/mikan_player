...
const BangumiRelationCacheSchema = CollectionSchema(
  ...
  properties: {
    r'cachedAt': PropertySchema(id: 0, name: r'cachedAt', type: IsarType.long),
    ...
    r'nameCn': PropertySchema(id: 6, name: r'nameCn', type: IsarType.string),
...
extension BangumiRelationCacheQueryWhere
  ...
  QueryBuilder<BangumiRelationCache, BangumiRelationCache, QAfterWhereClause>
  sourceSubjectIdGreaterThan(int sourceSubjectId, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'sourceSubjectId',
  ...
  QueryBuilder<BangumiRelationCache, BangumiRelationCache, QAfterWhereClause>
  sourceSubjectIdLessThan(int sourceSubjectId, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'sourceSubjectId',
...
extension BangumiRelationCacheQueryFilter
    on
        QueryBuilder<
          BangumiRelationCache,
          BangumiRelationCache,
          QFilterCondition
        > {
  QueryBuilder<
  ...
  nameCnIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'nameCn'),
      );
    });
  }
  ...
  nameCnIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'nameCn'),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  nameCnEqualTo(String? value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'nameCn',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  nameCnStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'nameCn',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  nameCnEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'nameCn',
  ...
  nameCnIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'nameCn', value: ''),
      );
    });
  }
  ...
  nameCnIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'nameCn', value: ''),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  relatedSubjectIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'relatedSubjectId', value: value),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  relatedSubjectIdGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  relatedSubjectIdLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  sourceSubjectIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'sourceSubjectId', value: value),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  sourceSubjectIdGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  sourceSubjectIdLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension BangumiRelationCacheQueryObject
    on
        QueryBuilder<
          BangumiRelationCache,
          BangumiRelationCache,
...
extension BangumiRelationCacheQueryLinks
    on
        QueryBuilder<
          BangumiRelationCache,
          BangumiRelationCache,
...
extension BangumiRelationCacheQueryProperty
    on
        QueryBuilder<
          BangumiRelationCache,
          BangumiRelationCache,
